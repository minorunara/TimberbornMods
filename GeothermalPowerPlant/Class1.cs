...
namespace TimberbornHotDryRockTurbine
{

    [BepInPlugin(PluginGuid, "GeothermalPowerPlant", PluginVersion)]
    [BepInDependency("com.timberapi.timberapi")]
    public class Plugin : BaseUnityPlugin
    {
        public const string PluginGuid = "minorunara.Timberborn.GeothermalPowerPlant";
    ...
    public class BuildingAdd : ILoadableSingleton
    {
        ...
        public void Load()
        {
            ...
            AddBuilding("GeothermalPowerPlant", shader);
            AddBuilding("CoolingTower", shader);
        ...
        {
            var building = _assetLoader.Load<GameObject>(Plugin.PluginGuid, $"geothermalpowerplant.bundle/{name}");
